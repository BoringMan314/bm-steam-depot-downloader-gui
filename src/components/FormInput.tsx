		...
		<>
			...
			<div className="flex gap-2 justify-start w-2/3">
				<button disabled={disabled} type="button" onClick={selectPath}
					className="inline-flex gap-2 justify-center items-center py-1 px-2 font-medium text-white rounded-md border border-gray-600 transition-transform disabled:cursor-not-allowed grow bg-blue-900/90 text-md enabled:active:scale-103 hover:bg-blue-900/65 active:bg-blue-900/40 disabled:bg-gray-700">
					<Icon icon="subway:folder-2" height="25" width="25" />選擇資料夾
				</button>
				...
				<button type="button" disabled={!path} onClick={() => {if (path) previewPath(); }}
					className="inline-flex gap-2 justify-center items-center py-1 px-2 font-medium text-white rounded-md border border-gray-600 transition-transform disabled:cursor-not-allowed grow bg-blue-900/90 text-md enabled:active:scale-103 hover:bg-blue-900/65 active:bg-blue-900/40 disabled:bg-gray-700">
					<Icon icon="material-symbols:folder-eye" height="25" width="25" />開啟資料夾
				</button>
			</div>
		</>
